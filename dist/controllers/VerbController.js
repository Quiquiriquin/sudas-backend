        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _index2.default.verb.create({
                description: description
              });

            case 4:
              newVerb = _context.sent;
              return _context.abrupt('return', res.status(201).send(newVerb));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _index2.default.verb.findAll();

            case 3:
              verbs = _context2.sent;
              return _context2.abrupt('return', res.status(200).send(verbs));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              id = req.params.id;
              _context3.next = 4;
              return _index2.default.verb.findOne({
                where: {
                  id: id
                }
              });
            ...
            case 4:
              verb = _context3.sent;
              return _context3.abrupt('return', res.status(200).send(verb));
      ...
      return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              return _context5.abrupt('return', res.status(200).send({ message: 'Verb deleted' }));
...
exports.default = VerbController;