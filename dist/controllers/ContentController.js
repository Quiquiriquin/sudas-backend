                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            body = req.body;
                            _context.next = 4;
                            return _index2.default.content.create((0, _extends3.default)({}, body));

                        case 4:
                            content = _context.sent;
                            return _context.abrupt('return', res.status(201).send(content));
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            query = req.query;
                            _context2.next = 4;
                            return _index2.default.content.findAll({
                                where: {
                                    subjectId: query.subjectId
                                },
                                include: [{
                                    model: _index2.default.unitCompetence,
                                    attributes: ['id', 'description']
                                }]
                            });

                        case 4:
                            filteredContents = _context2.sent;
                            return _context2.abrupt('return', res.status(200).send(filteredContents));
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 5;
                            return _index2.default.content.findOne({
                                where: {
                                    subjectId: subjectId
                                },
                                include: {
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            _context4.next = 4;
                            return _index2.default.content.update((0, _extends3.default)({}, body), {
                                where: {
                                    id: id
                                }
                            });
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            ...
                            id = req.params.id;
                            _context5.next = 4;
                            return _index2.default.content.destroy({
                                where: {
                                    id: id
                                }
                            });
